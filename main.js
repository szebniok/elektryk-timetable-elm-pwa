	...
	function (jsdb, json, day) {
		var getLessons = function (lesson) {
			...
			if (_p0.ctor === 'Err') {
				...
				return _szebniok$elektryk_timetable_elm_pwa$Parser$Lessons(_p0._0);
			}
		};
		return A2(
			_elm_lang$core$List$map,
...
var _szebniok$elektryk_timetable_elm_pwa$Main$tableCell = function (cell) {
...
var _szebniok$elektryk_timetable_elm_pwa$Main$headers = {
	ctor: '::',
...
var _szebniok$elektryk_timetable_elm_pwa$Main$test = _elm_lang$http$Http$request(
	{
		method: 'POST',
		headers: _szebniok$elektryk_timetable_elm_pwa$Main$headers,
		url: 'https://cors-anywhere.herokuapp.com/https://elektryk.edupage.org/gcall',
		body: A2(_elm_lang$http$Http$stringBody, 'text/plain', _szebniok$elektryk_timetable_elm_pwa$Main$params),
		expect: _elm_lang$http$Http$expectString,
		timeout: _elm_lang$core$Maybe$Nothing,
		withCredentials: false
	});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_szebniok$elektryk_timetable_elm_pwa$Main$Download),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _szebniok$elektryk_timetable_elm_pwa$Main$parameters = {
	ctor: '::',
	_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'gadget', 'MobileTimetableBrowser'),
	_1: {
		ctor: '::',
		_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'jscid', 'gi9195'),
		_1: {
			ctor: '::',
			_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'gsh', '06a16bc7'),
			_1: {
				ctor: '::',
				_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'action', 'reload'),
				_1: {
					ctor: '::',
					_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'num', '13'),
					_1: {
						ctor: '::',
						_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'oblast', 'trieda'),
						_1: {
							ctor: '::',
							_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, 'id', '-52'),
							_1: {
								ctor: '::',
								_0: A2(_szebniok$elektryk_timetable_elm_pwa$Main$Parameter, '_LJSL', '2048'),
								_1: {ctor: '[]'}
							}
						}
					}
