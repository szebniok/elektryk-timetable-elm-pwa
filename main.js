...
var _szebniok$elektryk_timetable_elm_pwa$Ports$readActiveClassData = _elm_lang$core$Native_Platform.incomingPort(
	'readActiveClassData',
...
var _szebniok$elektryk_timetable_elm_pwa$Ports$sendActiveClass = _elm_lang$core$Native_Platform.outgoingPort(
	'sendActiveClass',
	function (v) {
		return v;
	});

var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$Model = F5(
	function (a, b, c, d, e) {
		return {currentDayIndex: a, touchStart: b, data: c, online: d, activeClass: e};
	});
...
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$VersionJson = function (a) {
	return {ctor: 'VersionJson', _0: a};
};
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$Online = {ctor: 'Online'};
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$FromCache = function (a) {
	return {ctor: 'FromCache', _0: a};
};
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$NewContent = function (a) {
	return {ctor: 'NewContent', _0: a};
};
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$TouchEnd = function (a) {
	return {ctor: 'TouchEnd', _0: a};
};
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$TouchStart = function (a) {
...
var _szebniok$elektryk_timetable_elm_pwa$Settings_Rest$classListParser = function (raw) {
	...
	var result = function () {
		var _p0 = _elm_lang$core$List$head(firstMatch.submatches);
		if ((_p0.ctor === 'Just') && (_p0._0.ctor === 'Just')) {
			return A2(_elm_lang$core$Basics_ops['++'], _p0._0._0, ']');
		} else {
			return '';
		}
	}();
...
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$getTimetable = F3(
	function (msg, num, classId) {
		return A2(
			_elm_lang$http$Http$send,
			msg,
			A2(_szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$timetableRequest, num, classId));
	});
...
var _szebniok$elektryk_timetable_elm_pwa$Substitutions_State$store = F2(
	function (data, time) {
		return _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _szebniok$elektryk_timetable_elm_pwa$Ports$saveInLocalStorage(
					{ctor: '_Tuple2', _0: 'substitutions', _1: data}),
				_1: {
					ctor: '::',
					_0: _szebniok$elektryk_timetable_elm_pwa$Ports$saveInLocalStorage(
						{
							ctor: '_Tuple2',
							_0: 'substitutions-time',
							_1: _elm_lang$core$Basics$toString(time)
						}),
					_1: {ctor: '[]'}
				}
			});
...
var _szebniok$elektryk_timetable_elm_pwa$Timetable_State$init = F2(
	function (online, $class) {
		return A5(_szebniok$elektryk_timetable_elm_pwa$Timetable_Types$Model, 0, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Array$empty, online, $class);
	});
var _szebniok$elektryk_timetable_elm_pwa$Timetable_State$send = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$Task$succeed(msg));
};
var _szebniok$elektryk_timetable_elm_pwa$Timetable_State$store = F2(
	function ($class, str) {
		return _szebniok$elektryk_timetable_elm_pwa$Ports$saveInLocalStorage(
			{
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$Basics_ops['++'], $class.name, '_timetable'),
				_1: str
			});
	});
			...
			switch (_p0.ctor) {
				...
				case 'TouchStart':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								touchStart: _elm_lang$core$Maybe$Just(_p0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'TouchEnd':
					var _p3 = _p0._0;
					var _p1 = model.touchStart;
					if (_p1.ctor === 'Just') {
						var _p2 = _p1._0;
						var diffY = _p2.clientY - _p3.clientY;
						var diffX = _p2.clientX - _p3.clientX;
						if (_elm_lang$core$Native_Utils.cmp(
							...
							if (_elm_lang$core$Native_Utils.cmp(
								...
								if (_elm_lang$core$Native_Utils.cmp(diffX, 0) < 0) {
									var _v2 = _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$PrevDay,
									...
									var _v4 = _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$NextDay,
					...
					if (_p0._0.ctor === 'Ok') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									data: _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$parse(_p4)
								}),
							_1: A2(_szebniok$elektryk_timetable_elm_pwa$Timetable_State$store, model.activeClass, _p4)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'FromCache':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								data: _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$parse(_p0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Online':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$getNewestNumber(_szebniok$elektryk_timetable_elm_pwa$Timetable_Types$VersionJson)
					};
				case 'VersionJson':
					if (_p0._0.ctor === 'Ok') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: _szebniok$elektryk_timetable_elm_pwa$Timetable_State$send(
								_szebniok$elektryk_timetable_elm_pwa$Timetable_Types$Fetch(
									_szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$globalUpdateParser(_p0._0._0)))
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				...
				default:
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _szebniok$elektryk_timetable_elm_pwa$Timetable_State$send(_szebniok$elektryk_timetable_elm_pwa$Timetable_Types$Online)
					};
			}
		}
	});

var _szebniok$elektryk_timetable_elm_pwa$Types$reversePage = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
		case 'TimetablePage':
			return '/';
...
var _szebniok$elektryk_timetable_elm_pwa$Types$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {online: a, page: b, timetable: c, substitutions: d, substitutionsFromStorage: e, classes: f, activeClass: g};
	});
...
var _szebniok$elektryk_timetable_elm_pwa$Types$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _szebniok$elektryk_timetable_elm_pwa$Types$TimetablePage, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
...
var _szebniok$elektryk_timetable_elm_pwa$Types$parseLocation = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_szebniok$elektryk_timetable_elm_pwa$Types$NotFoundPage,
		A2(_evancz$url_parser$UrlParser$parsePath, _szebniok$elektryk_timetable_elm_pwa$Types$routeParser, location));
};
var _szebniok$elektryk_timetable_elm_pwa$Types$ReadActiveClass = function (a) {
	return {ctor: 'ReadActiveClass', _0: a};
};
var _szebniok$elektryk_timetable_elm_pwa$Types$SetClass = function (a) {
	return {ctor: 'SetClass', _0: a};
};
var _szebniok$elektryk_timetable_elm_pwa$Types$DownloadClasses = {ctor: 'DownloadClasses'};
var _szebniok$elektryk_timetable_elm_pwa$Types$GetClasses = function (a) {
	return {ctor: 'GetClasses', _0: a};
};
...
var _szebniok$elektryk_timetable_elm_pwa$Types$UrlChange = function (a) {
...
var _szebniok$elektryk_timetable_elm_pwa$State$subscriptions = function (model) {
	return _szebniok$elektryk_timetable_elm_pwa$Ports$readActiveClassData(_szebniok$elektryk_timetable_elm_pwa$Types$ReadActiveClass);
};
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								...
								_1: {
									ctor: '::',
									_0: _szebniok$elektryk_timetable_elm_pwa$Ports$sendActiveClass($class.name),
									_1: {ctor: '[]'}
								}
							})
					};
...
var _szebniok$elektryk_timetable_elm_pwa$Settings_View$onSelect = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
...
var _szebniok$elektryk_timetable_elm_pwa$Settings_View$classSelect = function (classes) {
	return A2(
		...
		{
			ctor: '::',
			_0: _szebniok$elektryk_timetable_elm_pwa$Settings_View$onSelect(_szebniok$elektryk_timetable_elm_pwa$Types$SetClass),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_szebniok$elektryk_timetable_elm_pwa$Types$DownloadClasses),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Pobierz klasy'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _szebniok$elektryk_timetable_elm_pwa$Settings_View$classSelect(model.classes),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _szebniok$elektryk_timetable_elm_pwa$Timetable_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_knledg$touch_events$TouchEvents$onTouchEvent, _knledg$touch_events$TouchEvents$TouchStart, _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$TouchStart),
				_1: {
					ctor: '::',
					_0: A2(_knledg$touch_events$TouchEvents$onTouchEvent, _knledg$touch_events$TouchEvents$TouchEnd, _szebniok$elektryk_timetable_elm_pwa$Timetable_Types$TouchEnd),
					_1: {ctor: '[]'}
				}
			}
		},
			...
			_1: {
				...
				_1: {
					...
					_0: model.online ? A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_szebniok$elektryk_timetable_elm_pwa$Timetable_Types$Update),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _szebniok$elektryk_timetable_elm_pwa$View$navigation = function (page) {
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$href(
								_szebniok$elektryk_timetable_elm_pwa$Types$reversePage(page)),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(navigationLink, _szebniok$elektryk_timetable_elm_pwa$Types$TimetablePage, 'Plan lekcji'),
			_1: {
				ctor: '::',
	...
	switch (_p0.ctor) {
		case 'TimetablePage':
			return A2(
				...
				_szebniok$elektryk_timetable_elm_pwa$Types$TimetableMsg,
				_szebniok$elektryk_timetable_elm_pwa$Timetable_View$root(model.timetable));
		case 'SubstitutionsPage':
			return A2(
				_elm_lang$html$Html$map,
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Żądana strona nie została znaleziona'),
					_1: {ctor: '[]'}
				});
	}
};
...
var _szebniok$elektryk_timetable_elm_pwa$Main$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_szebniok$elektryk_timetable_elm_pwa$Types$UrlChange,
