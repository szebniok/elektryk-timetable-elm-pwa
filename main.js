...
var _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$parse = function (json) {
	var jsdbData = _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$makeJsdb(json);
	return A2(_szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$getAllDays, jsdbData, json);
};
			...
			switch (_p1.ctor) {
				case 'NewContent':
					if (_p1._0.ctor === 'Ok') {
						...
						var parsedContent = _szebniok$elektryk_timetable_elm_pwa$Timetable_Rest$parse(newContent);
